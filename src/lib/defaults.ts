...
export const DEFAULT_CATEGORY_TREE: CategoryDef[] = [
  ...
  },
  {
    ...
    color: "#ef4444",
    icon: "HeartPulse",
    children: ["Plano de Saúde", "Farmácia", "Consultas e Exames", "Academia e Bem-estar"],
  },
  {
    name: "Educação",
    type: "EXPENSE",
...
export const CATEGORY_KEYWORD_RULES: { category: string; keywords: string[] }[] = [
  ...
  { category: "Água e Esgoto", keywords: ["agua e esgoto", "água e esgoto", "sabesp", "copasa", "cedae", "embasa"] },
  {
    category: "Academia e Bem-estar",
    keywords: [
      "academia",
      "smart fit",
      "smartfit",
...
export const TRANSFER_KEYWORDS = [
  ...
  "fatura cartao visa",
  "fatura cartão visa",
  "fatura cartao mastercard",
  "fatura cartão mastercard",
];
